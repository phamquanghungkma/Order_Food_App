...
class CommentFragment : BottomSheetDialogFragment(), ICommentCallBack {
    ...
    private fun initViews( itemView : View?) {
        ...
        val layoutManger = LinearLayoutManager(context,RecyclerView.VERTICAL,true)
        recycler_comment!!.layoutManager = layoutManger
        recycler_comment!!.addItemDecoration(DividerItemDecoration(context!!,layoutManger.orientation))
    }
